...
import mk.org.zels.ejb.CommentsFacade;
...
public class CommentsController implements Serializable {
    ...
    @EJB
    private mk.org.zels.ejb.CommentsFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/bundle").getString("CommentsCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/bundle").getString("CommentsUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/bundle").getString("CommentsDeleted"));
        if (!JsfUtil.isValidationFailed()) {
