...
import mk.org.zels.ejb.FilesFacade;
...
public class FilesController implements Serializable {
    ...
    @EJB
    private mk.org.zels.ejb.FilesFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/bundle").getString("FilesCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/bundle").getString("FilesUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/bundle").getString("FilesDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Files> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Files> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class FilesControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Files) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Files.class.getName()});
                return null;
            }
        }
