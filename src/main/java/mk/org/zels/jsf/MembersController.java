...
import mk.org.zels.ejb.MembersFacade;
...
public class MembersController implements Serializable {
    ...
    @EJB
    private mk.org.zels.ejb.MembersFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/bundle").getString("MembersCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/bundle").getString("MembersUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/bundle").getString("MembersDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class MembersControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Members) {
                ...
                return getStringKey(o.getMemberId());
            } else {
